...
// print html output
echo "<html><head><title>Business Application month-to-day report</title></head><body>\r\n";
echo "<table width='90%' cellspacing='0' cellpadding='0'>\r\n";
echo "<tr><th>BusinessApp</th><th>Prev. month-to-date<br /><small>[".$monthb4_start."&nbsp;/&nbsp;".$monthb4_end."]</small></th><th>Current month-to-date<br /><small>[".$month_start."&nbsp;/&nbsp;".$month_end."]</small></th><th>Delta cost</th><th>Percentage</th><th>Trend</th></tr>\r\n";
